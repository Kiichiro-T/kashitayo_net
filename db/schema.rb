...
ActiveRecord::Schema.define(version: 2019_12_17_070103) do
  ...
  create_table "debtor_transactions", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.bigint "debtor_id"
    t.integer "debt"
    t.boolean "repayment", default: false, null: false
    t.datetime "created_at", null: false
  ...
  add_foreign_key "creditor_transactions", "users", column: "creditor_id"
